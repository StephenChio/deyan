package com.OneTech.common.util.massageUtils.massage;
...
//		ConfigManager.removeAllIpInfo();
	...
	public static void singleSend(String userid, String pwd,boolean isEncryptPwd)
	{
		try
		{
			...
			// 设置手机号码 此处只能设置一个手机号码
			message.setMobile("13415526879");
			message.setApikey("77a41cdf0368df13202e868accd7e825");
			// 设置内容
			message.setContent("您的验证码是123342，在1分钟内有效。如非本人操作请忽略本短信。");
			// 设置扩展号
			message.setExno("11");
			// 用户自定义流水编号
